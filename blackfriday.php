...
<html lang="en">
  ...
  <div class="box-container limit-width">
    ...
    <div class="top-header scrollme">
      <img class="svg pattern" src="assets/patterns/promo-w.svg" alt="promos">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="wrapper animateme" data-when="span" data-from="0" data-to="0.75" data-opacity="1" data-translatey="-50">
              <div class="float-end"><a href="https://themeforest.net/item/antler-hosting-provider-whmcs-template/23139614" target="_blank" class="btn btn-default-pink-fill">Buy Antler Now</a></div>
              <div class="heading darkcolor">Black Friday <b class="c-pink">Sale*</b></div>
              <div class="subheading darkcolor">Antler template was build in HTML5 and CSS3 technology based on Bootstrap Framework and developed to directly integrate with the WHMCS Client Area, through login, domain search and Hosting e VPS plans (already integrated).</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- ***** COUNTDOWN ***** -->
    <div class="pt-4 pb-4 mb-0 sec-bg2 alert alert-dismissible fade show" role="alert">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h4 class="count-txt pe-2 mb-0"><span class="c-pink">*</span> Special Offer - 50% Off Antler Template </h4>
          </div>
          <div class="col-md-5">
            <div class="count-content float-end">
              <h4 class="mb-0"><strong id="specialclock" class="clock c-pink"></strong></h4>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- ***** PROMO PLANS ***** -->
    <section class="services blog sec-normal pt-5 bg-colorstyle">
      <div class="container">
        <div class="service-wrap">
          <div class="row">
            <div class="col-md-4">
              <img src="assets/img/blackfriday/bf-whmcs.jpg" data-src="./assets/img/blackfriday/bf-whmcs.jpg" class="img-responsive lazyload" alt="photo">
              <div class="service-section m-0 bg-seccolorstyle noshadow">
                <div class="plans badge feat bg-pink">WHMCS</div>
                <div class="title mt-0 mergecolor">WHMCS Client Area</div>
                <p class="subtitle seccolor">WHMCS Client Area or (Default Six Template) is a <span class="c-pink">turn-key project</span> developed by WHMCS, allowing you to launch a new online business easily and efficiently.</p>
                <hr>
                <div class="small d-flex align-items-center seccolor">
                  <span class="icon-inverse text-dark h3 mb-0 me-2 seccolor"></span>
                  <span>WHMCS RTL version available</span>
                </div>
                <a href="https://inebur.com/whmcs/?systpl=antler&carttpl=antler" target="_blank" class="btn btn-default-yellow-fill">See Now</a>
              </div>
            </div>
            <div class="col-md-4">
              <img src="assets/img/blackfriday/bf-orderform.jpg" data-src="./assets/img/blackfriday/bf-orderform.jpg" class="img-responsive lazyload" alt="photo">
              <div class="service-section m-0 bg-seccolorstyle noshadow">
                <div class="plans badge feat bg-pink">order form</div>
                <div class="title mt-0 mergecolor">WHMCS Order Form</div>
                <p class="subtitle seccolor">Built-in Order Form Antler Template - WHMCS Order Form Template, <span class="c-pink">define the look and feel of the shopping cart process</span> of your WHMCS Client Area.</p>
                <hr>
                <div class="small d-flex align-items-center seccolor">
                  <span class="icon-device text-dark h3 mb-0 me-2 seccolor"></span>
                  <span>100% compatible with WHMCS</span>
                </div>
                <a href="https://inebur.com/whmcs/index.php/store/shared-hosting/?systpl=antler&carttpl=antler" target="_blank" class="btn btn-default-yellow-fill">See Now</a>
              </div>
            </div>
            <div class="col-md-4">
              <img src="assets/img/blackfriday/bf-newsletter.jpg" data-src="./assets/img/blackfriday/bf-newsletter.jpg" class="img-responsive lazyload" alt="photo">
              <div class="service-section m-0 bg-seccolorstyle noshadow">
                <div class="plans badge feat bg-pink">newsletter</div>
                <div class="title mt-0 mergecolor">WHMCS Newsletter</div>
                <p class="subtitle seccolor">You can use the WHMCS Newsletter Template on your own newsletter templates (Email) and send manually or massive via WHMCS any time.</p>
                <hr>
                <div class="small d-flex align-items-center seccolor">
                  <span class="icon-alpha text-dark h3 mb-0 me-2 seccolor"></span>
            ...
            <div class="col-md-4">
              <img src="assets/img/blackfriday/bf-email.jpg" data-src="./assets/img/blackfriday/bf-email.jpg" class="img-responsive lazyload" alt="photo">
              <div class="service-section m-0 bg-seccolorstyle noshadow">
                <div class="plans badge feat bg-pink">email</div>
                <div class="title mt-0 mergecolor">WHMCS Email Template</div>
                <p class="subtitle seccolor">Install and customize your Antler WHMCS Email Template. You can use the custom email template and send manually via WHMCS for all your customers.</p>
                <hr>
                <div class="small d-flex align-items-center seccolor">
                  <span class="icon-emailopen text-dark h3 mb-0 me-2 seccolor"></span>
                  <span>Compatible with all email clients</span>
                </div>
                <a href="http://inebur.com/antler/email/" target="_blank" class="btn btn-default-yellow-fill">See Now</a>
              </div>
            </div>
            <div class="col-md-4">
              <img src="assets/img/blackfriday/bf-demos.jpg" data-src="./assets/img/blackfriday/bf-demos.jpg" class="img-responsive lazyload" alt="photo">
              <div class="service-section m-0 bg-seccolorstyle noshadow">
                <div class="plans badge feat bg-pink">demos</div>
                <div class="title mt-0 mergecolor">45+ Real Hosting Demos</div>
                <p class="subtitle seccolor">Customize and add new resources or component according to your requirements quickly and easily through <span class="c-pink">35+ short-code elements</span></p>
                <hr>
                <div class="small d-flex align-items-center seccolor">
                  <span class="icon-layers text-dark h3 mb-0 me-2 seccolor"></span>
                  <span>Great foundations to big projects</span>
                </div>
            ...
            <div class="col-md-4">
              <img src="assets/img/blackfriday/bf-svg.jpg" data-src="./assets/img/blackfriday/bf-svg.jpg" class="img-responsive lazyload" alt="photo">
              <div class="service-section m-0 bg-seccolorstyle noshadow">
                <div class="plans badge feat bg-pink">SVG</div>
                <div class="title mt-0 mergecolor">60+ animated illustrations</div>
                <p class="subtitle seccolor">The variety of devices, screen sizes, and display resolutions makes scalability and quality essential in providing your digital audience with an optimal experience.</p>
                <hr>
                <div class="small d-flex align-items-center seccolor">
                  <span class="icon-editable text-dark h3 mb-0 me-2 seccolor"></span>
                  <span>SVG & AI editable format</span>
                </div>
                <a href="https://themeforest.net/item/antler-hosting-provider-whmcs-template/23139614" target="_blank" class="btn btn-default-yellow-fill">Get Now</a>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-4 animateme" data-when="enter" data-from="1" data-to="0" data-opacity="1" data-translatey="-100" data-easeinout="0">
              <div class="service-section bg-colorstyle">
                ...
                <img class="svg" src="assets/fonts/svg/location.svg" alt="">
                <div class="title mergecolor">i18n Language Translation</div>
            ...
            <div class="col-sm-12 col-md-4 animateme" data-when="enter" data-from="1" data-to="0" data-opacity="1" data-translatey="100" data-easeinout="0">
              <div class="service-section bg-colorstyle">
                ...
                <img class="svg" src="assets/fonts/svg/emailopen.svg" alt="">
                <div class="title mergecolor">Working PHP Contact Form</div>
                <p class="subtitle seccolor">
                  Send the form contents to your email easily through a well-written php code.
                </p>
              </div>
            </div>
            <div class="col-sm-12 col-md-4 animateme" data-when="enter" data-from="1" data-to="0" data-opacity="1" data-translatey="-100" data-easeinout="0">
              <div class="service-section bg-colorstyle">
                ...
                <img class="svg" src="assets/fonts/svg/livechat.svg" alt="">
                <div class="title mergecolor">Tawk Modern Live Chat</div>
                <p class="subtitle seccolor">
                  Tawk is a free messaging app to monitor and chat with the visitors on your site.
                </p>
              </div>
            </div>
          </div>
    ...
    <!-- ***** COUPONS ***** -->
    <section class="getready sec-bg3 scrollme bg-colorstyle">
      <div class="container">
        <div class="row">
          <div class="col-lg-9">
            <div class="column-support-txt animateme" data-when="enter" data-from="1" data-to="0" data-opacity="1" data-translatex="-60" data-easeinout="0">
              <div class="column-support-title mergecolor">Get Antler now and save 50% off</div>
              <div class="column-support-subtitle mergecolor">This all features and more makes Antler the Most Complete Hosting Template on the Market</div>
            </div>
          </div>
          <div class="col-lg-3">
      ...
      <div class="container">
        <div class="service-wrap">
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
              <div class="service-section bg-colorstyle noshadow">
                <img src="assets/img/payments/mastercard.svg" class="lazyload" alt="">
                <hr>
                <p class="subtitle seccolor">
                  Excepteur sint occaecat cupidatat
                </p>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
              <div class="service-section bg-colorstyle noshadow">
                <img src="assets/img/payments/americanexpress.svg" class="lazyload" alt="">
                <hr>
                <p class="subtitle seccolor">
                  Excepteur sint occaecat cupidatat
                </p>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
              <div class="service-section bg-colorstyle noshadow">
                <img src="assets/img/payments/discover.svg" class="lazyload" alt="">
                <hr>
                <p class="subtitle seccolor">
                  Excepteur sint occaecat cupidatat
                </p>
