            ...
            <div class="carousel header-main-slider">
              ...
              <div class="carousel-cell sec-bg6 bg-colorstyle">
                <div class="slider-content">
                  <div class="container ">
                    <img class="svg custom-element-right" src="assets/patterns/cryptoexchange.svg" alt="Crypto Exchange">
                    <div class="col-sm-12 col-md-7 px-0">
                      <h1 class="mergecolor" data-aos="fade-up" data-aos-duration="800">Trusted & secure <br>crypto exchange</h1>
                      <p class="text-break seccolor" data-aos="fade-up" data-aos-duration="1200">Trade Bitcoin, Ethereum and other using our crypto trading app.</p>
                      <a href="contact.php" class="btn btn-default-yellow-fill me-2">Get Started</a>
                      <a href="cryptotrading.php" class="btn btn-default-pink-fill">Learn more</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="sec-main sec-bg1 bg-colorstyle noshadow nopadding">
                    <div class="row">
                        <div class="col-md-12 col-lg-5 wow animated fadeInUp fast first">
                            <img class="svg" src="assets/patterns/cryptocart.svg" alt="Crypto Invest">
                        </div>
                        <div class="col-md-12 col-lg-6 offset-lg-1">
                            <div class="info-content">
                                ...
                                <div class="included">
                                    <ul>
                                      <li><i class="fas fa-check-circle"></i> <span class="text-muted seccolor">Top trading platform</span></li>
                                    </ul>
                                    <ul>
                                      <li><i class="fas fa-check-circle"></i> <span class="text-muted seccolor">Secure payments</span></li>
                                    </ul>
                                    <ul>
                                      <li><i class="fas fa-check-circle"></i> <span class="text-muted seccolor">Easy to start trading</span></li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="service-wrap">
              <div class="row">
                <div class="col-sm-12 text-center">
                  ...
                  <p class="section-subheading">Cryptocurrency markets have seen an increase in volume in recent weeks, which is a great opportunity for new traders.</p>
                </div>
                <div class="col-md-12 col-lg-4 wow animated fadeInUp fast">
                  <div class="service-section bg-colorstyle noshadow">
                    ...
                    <img class="svg" src="assets/fonts/svg/cryptographic.svg" alt="">
                    <div class="title mergecolor">Profitability</div>
                    <p class="subtitle seccolor">
                      Excepteur sint occaecat cupidatat non proident voluptate
                    </p>
                ...
                <div class="col-md-12 col-lg-4 wow animated fadeInUp">
                  <div class="service-section bg-colorstyle noshadow">
                    ...
                    <img class="svg" src="assets/fonts/svg/cryptoinvisible.svg" alt="">
                    <div class="title mergecolor">Transparency</div>
                    <p class="subtitle seccolor">
                ...
                <div class="col-md-12 col-lg-4 wow animated fadeInUp fast">
                  <div class="service-section bg-colorstyle noshadow">
                    <img class="svg" src="assets/fonts/svg/cryptosecurity.svg" alt="">
                    <div class="title mergecolor">Security</div>
                    <p class="subtitle seccolor">
                      Excepteur sint occaecat cupidatat non proident voluptate
                    </p>
                    <a href="" class="btn btn-default-yellow-fill">Read more</a>
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="image-link popup-youtube" title="Our Team">
                          <img src="assets/img/topbanner22.jpg" class="d-block w-100" alt="About Us">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="help-container bg-seccolorstyle noshadow">
                                ...
                                <a href="cryptotrading.php" class="help-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/bitcoin.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                                        <div class="title mergecolor">Go to Crypto Trading Service</div>
                                        <div class="description seccolor">But I must explain to you how all mistaken?</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="help-container bg-seccolorstyle noshadow">
                                ...
                                <a href="hosting.php" class="help-item">
                                    ...
                                    <div class="inform">
                                        ...
                                        <div class="description seccolor">Lorem ipsum dolor sit amet?</div>
                                    </div>
                                </a>
                            </div>
                        </div>
