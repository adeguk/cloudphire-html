...
<html lang="en">
  ...
  <div class="box-container limit-width">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12">
            <div class="wrapper animateme" data-when="span" data-from="0" data-to="0.75" data-opacity="1" data-translatey="-50">
              <h1 class="heading">Database-as-a-Service</h1>
              <h3 class="subheading mb-3">Get a performance-optimized database for your application in minutes.</h3>
              <a class="golink gocheck" href="#features">Check all features</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="best-plans pricing">
        <div class="container">
          ...
          <div class="sec-main sec-bg1">
            <div class="plans badge feat bg-pink hideelement">Compare All DBaaS Plans</div>
            <div class="tabs-header btn-select-plan">
              <ul class="btn-group">
                <li class="btn btn-secondary active mb-2">DBaaS SQL Server</li>
                <li class="btn btn-secondary">DBaaS MySQL Server</li>
              </ul>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div id="table-container" class="table-responsive-lg tabs-content">
                  <table id="maintable" class="table tabs-item active">
                    <thead>
                      <tr>
                        ...
                        <td class="price-container">
                          <div class="title">SQL Starter</div>
                          <div class="price mergecolor"><sup>$</sup>34.80<span class="period">/year</span></div>
                        ...
                        <td class="price-container">
                          <div class="title">SQL Pro</div>
                          <div class="price mergecolor"><sup>$</sup>72.00<span class="period">/year</span></div>
                          <div class="info seccolor">Sed ut perspiciatis unde omnis natus error voluptatem</div>
                          <a href="" class="btn btn-default-yellow-fill">Buy Now</a>
                        </td>
                        <td class="price-container">
                          <div class="title">SQL Enterprise</div>
                          <div class="price mergecolor"><sup>$</sup>154.80<span class="period">/year</span></div>
                          <div class="info seccolor">Sed ut perspiciatis unde omnis natus error voluptatem</div>
                          <a href="" class="btn btn-default-yellow-fill ">Buy Now</a>
                        </td>
                      </tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="title-table"><span class="badge bg-grey">auto</span> Daily Backups</td>
                        <td>Daily (last 16 days)</td>
                      ...
                      <tr>
                        <td class="title-table">Management</td>
                        <td><i class="fas fa-times seccolor"></i></td>
                        <td><i class="fas fa-check seccolor"></i></td>
                        <td><i class="fas fa-check seccolor"></i></td>
                      </tr>
                      <tr>
                        <td class="title-table"><span class="badge bg-grey">auto</span> Updates</td>
                        <td><i class="fas fa-times seccolor"></i></td>
                        <td><i class="fas fa-check seccolor"></i></td>
                        <td><i class="fas fa-check seccolor"></i></td>
                      </tr>
                      <tr>
                        <td class="title-table">High Availability</td>
                        <td><i class="fas fa-check seccolor"></i></td>
                        <td><i class="fas fa-check seccolor"></i></td>
                        <td><i class="fas fa-check seccolor"></i></td>
                      </tr>
                      <tr>
                        <td class="title-table"><span class="badge bg-purple">premium</span>  24/7 Ticket Support</td>
                        <td><i class="fas fa-check seccolor"></i></td>
                        <td><i class="fas fa-check seccolor"></i></td>
                        <td><i class="fas fa-check seccolor"></i></td>
                      </tr>
                  ...
                  <table id="mysqlserver" class="table tabs-item">
                    <thead>
                      <tr>
                        <td></td>
                        <td class="price-container">
                          <div class="title">MySQL Starter</div>
                          <div class="price mergecolor"><sup>$</sup>30.00<span class="period">/year</span></div>
                          <div class="info seccolor">Sed ut perspiciatis unde omnis natus error voluptatem</div>
                          <a href="" class="btn btn-default-yellow-fill">Buy Now</a><br>
                        </td>
                        <td class="price-container">
                          <div class="title">MySQL Pro</div>
                          <div class="price mergecolor"><sup>$</sup>54.00<span class="period">/year</span></div>
                          <div class="info seccolor">Sed ut perspiciatis unde omnis natus error voluptatem</div>
                          <a href="" class="btn btn-default-yellow-fill">Buy Now</a>
                        </td>
                        <td class="price-container">
                          <div class="title">MySQL Enterprise</div>
                          <div class="price mergecolor"><sup>$</sup>132.80<span class="period">/year</span></div>
                          <div class="info seccolor">Sed ut perspiciatis unde omnis natus error voluptatem</div>
                          <a href="" class="btn btn-default-yellow-fill">Buy Now</a>
                        </td>
                      </tr>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-lg-6 offset-lg-1">
              <div class="info-content">
                <h1 class="fw-bold mb-3 mergecolor">Awesome performance & scalability</h1>
    ...
    <!-- **** CONTROL PANEL TOUR ***** -->
    <section class="sec-normal history-section custom-flip sec-bg3 motpath scrollme bg-colorstyle">
      <div class="container">
    ...
    <!-- ***** WHY CHOOSE ANTLER ***** -->
    <section class="services sec-normal sec-bg2 bg-seccolorstyle bottomhalfpadding">
      <div class="container">
        <div class="randomline">
          <div class="bigline"></div>
          <div class="smallline"></div>
        ...
        <div class="service-wrap">
          <div class="row">
            <div class="col-sm-12 text-center">
              <h2 class="section-heading mergecolor">Why choose Antler Plans for your DBaaS Server?</h2>
            ...
            <div class="col-sm-12 col-md-4">
              <div class="service-section bg-colorstyle noshadow">
                ...
                <div class="title mergecolor">Simple to Use</div>
            ...
            <div class="col-sm-12 col-md-4">
              <div class="service-section bg-colorstyle noshadow">
                ...
                <div class="title mergecolor">Fully Managed</div>
                <p class="subtitle seccolor">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="service-section bg-colorstyle noshadow">
                <div class="plans badge feat bg-pink">SSD</div>
                <img class="svg" src="assets/fonts/svg/redundancy.svg" alt="">
                <div class="title mergecolor">Performance Optimized</div>
                <p class="subtitle seccolor">
                  Excepteur sint occaecat cupidatat non proident voluptate. Lorem ipsum dolor sit amet, consectetur.
                </p>
              </div>
