...
<html lang="en">
  <head>
    ...
    <!-- CSS styles -->
    <link href="assets/css/bootstrap.min.css" rel="stylesheet" class="ltr" class="ltr" onload="if(media!='all')media='all'">
  ...
  <div class="box-container limit-width">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12">
            <div class="wrapper">
              ...
              <h3 class="subheading mb-3">High performance dedicated servers with cloud flexibility and scalability.</h3>
              <a href="#features" class="golink gocheck"> Features </a>
              <a href="#addons" class="golink gocheck"> Add-Ons </a> 
              <a href="#highlights" class="golink gocheck"> Highlights</a><br>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="cd-filter-block" data-filter-group="">
                    ...
                    <div class="cd-filter-content cd-filters list seccolor">
                      <datalist>
                      ...
                      <div class="range-slider">
                        <input name="minSize" class="range-slider-input tooltip-parent seccolor" type="range" min="0" max="5" value="0" data-list="sizeLegend">
                      </div>
                      <div class="range-slider">
                        <input name="maxSize" class="range-slider-input tooltip-parent seccolor" type="range" min="0" max="5" value="5" data-list="sizeLegend">
                      </div>
                    </div>
    ...
    <!-- ***** FILTER PLANS ***** -->
    <div class="mixcontainer pb-5 pt-4 sec-bg2 motpath bg-colorstyle" data-ref="container">
      <div class="container ">
        ...
        <div class="cd-fail-message bg-seccolorstyle seccolor noshadow">" No items could be found matching the criteria "</div>
      </div>
    </div>
    <!-- ***** FEATURES ***** -->
    <section id="features" class="history-section sec-normal bg-colorstyle">
      <div class="container">
          ...
          <div class="row">
            <div class="col-md-10 offset-md-1">
              <div class="info-content">
                <h2 class="mb-4 mergecolor"><b>SO Installation</b></h2>
            ...
            <div class="col-md-10 offset-md-1 pt-5 wow animated fadeInUp fast">
              <img class="svg" src="assets/patterns/os.svg" alt="dns redundant">
            </div>
          </div>
          <div class="row">
            <div class="col-md-10 offset-md-1">
    ...
    <!-- ***** CUSTOMIZE ***** -->
    <section id="addons" class="sec-normal history-section custom sec-bg3 bg-seccolorstyle">
      <div class="faq">
        <div class="container">
          <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
              <h2 class="section-heading text-white mergecolor">Customise with premium add-ons</h2>
                ...
                <div class="tabs offers-tabs">
                  <div class="tabs-header mb-5">
                    <ul>
                      <li class="col-sm-12 col-md-3 col-lg-3 text-white active">
                        <i class="icon-preferences"></i> <div class="mergecolor">Control Panel</div>
                      </li>
                      <li class="col-sm-12 col-md-3  col-lg-3 text-white">
                        <i class="icon-speed"></i> <div class="text-white mergecolor">Bandwidth</div>
                      </li>
                      <li class="col-sm-12 col-md-3  col-lg-3 text-white">
                        <i class="icon-privacy"></i> <div class="mergecolor">SSL Certificates</div>
                      </li>
                      <li class="col-sm-12 col-md-3  col-lg-2 text-white">
                        <i class="icon-protection"></i> <div class="mergecolor">Protection</div>
                      </li>
                    </ul>
                  </div>
                  <div class="tabs-content text-start scrollme">
                    ...
                    <div class="tabs-item">
                      <div class="row">
                        <div class="col-md-12 col-lg-5">
                          <img class="svg" src="assets/patterns/performance.svg" alt="performance">
                        </div>
                        <div class="col-md-12 col-lg-6 offset-lg-1">
                          <div class="info-content text-white">
                    ...
                    <div class="tabs-item">
                      <div class="row">
                        <div class="col-md-12 col-lg-5">
                          <img class="svg" src="assets/patterns/ssl.svg" alt="SSL Certificates">
                        </div>
                        <div class="col-md-12 col-lg-6 offset-lg-1">
                          <div class="info-content text-white">
                    ...
                    <div class="tabs-item">
                      <div class="row">
                        <div class="col-md-12 col-lg-5">
                          <img class="svg" src="assets/patterns/protectvisitors.svg" alt="Protection">
                        </div>
                        <div class="col-md-12 col-lg-6 offset-lg-1">
                          <div class="info-content text-white">
                            <h4 class="mergecolor">Maximum Physical Security</h4>
                            <p class="seccolor">But I must explain to you how all this mistaken idea of <a href="#" class="golink">denouncing pleasure</a> and praising pain was born and I will. </p>
                            <p class="seccolor">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                          </div>
                        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12 text-center">
              <h2 class="section-heading mergecolor">Dedicated Technical Specifications</h2>
            ...
            <div class="col-sm-12">
              <div class="table-responsive-lg">
                <table class="table sample mt-5">
                  ...
                  <tbody>
                    <tr><td><div class="title-table" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span class="fas fa-check-circle me-2 f-20"></span> Instant Provisioning</div></td><td><span class="fas fa-check-circle me-2 f-20"></span> Intel Xeon</td><td><span class="fas fa-check-circle me-2 f-20"></span> Free cPanel</td></tr>
                    <tr><td><div class="title-table" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span class="fas fa-check-circle me-2 f-20"></span> CentOS / Ubuntu</div></td><td><span class="fas fa-check-circle me-2 f-20"></span> SuperMicro</td><td><span class="fas fa-check-circle me-2 f-20"></span> WHMCS</td></tr>
                    <tr>
                      <td class="title-table"><span class="fas fa-check-circle me-2"></span> CloudLinux</td>
                      <td><span class="fas fa-check-circle me-2 f-20"></span> Juniper Networks</td>
                      <td><span class="fas fa-check-circle me-2 f-20"></span> IPs</td>
                    </tr>
                    <tr>
                      <td class="title-table"><span class="fas fa-check-circle me-3"></span> Server Rebuild</td>
                      <td><span class="fas fa-check-circle me-2 f-20"></span> DDos mitigation</td>
                      <td><span class="fas fa-check-circle me-2 f-20"></span> SAN storage</td>
                    </tr>
                    <tr>
    ...
    <section id="highlights" class="sec-normal best-plans pricing cpupath sec-bg4 scrollme bg-colorstyle">
      <div class="container">
        <div class="sec-main sec-bg1 animateme">
            ...
            <div class="col-sm-12">
              <div class="table-responsive-lg">
                <table class="table compare">
                  ...
                  <tbody>
                    <tr>
                      <td><div class="badge bg-pink me-1">HOT</div> E3-1230 v3 3.3GHz Haswell | 4 Cores</td>
                      <td>32GB</td>
                      <td>320GB SSD</td>
                    ...
                    <tr>
                      <td><div class="badge bg-pink me-1">SALE</div> E3-1230 v5 3.4GHz Skylake | 4 Cores</td>
                      <td>32GB</td>
                      <td>520GB SSD</td>
                    ...
                    <tr>
                      <td><div class="badge bg-grey me-1">OUT</div> E3-1230 v5 3.4GHz Skylake | 8 Cores</td>
                      <td>64GB</td>
                      <td>960GB SSD</td>
    ...
    <!-- ***** HELP ***** -->
    <section class="help pt-4 pb-80 bg-colorstyle">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6">
            <div class="help-container bg-seccolorstyle noshadow">
              ...
              <a href="vps.php" class="help-item">
                <div class="img">
