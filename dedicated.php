              ...
              <div class="tabs-header mb-5">
                <ul>
                  <li class="col-sm-12 col-md-3 col-lg-3 text-white active">
                    ...
                    <div class="mergecolor">Control Panel</div>
                  </li>
                  <li class="col-sm-12 col-md-3  col-lg-3 text-white">
                    <i class="icon-speed"></i>
                    <div class="text-white mergecolor">Bandwidth</div>
                  </li>
                  <li class="col-sm-12 col-md-3  col-lg-3 text-white">
                    <i class="icon-privacy"></i>
                    <div class="mergecolor">SSL Certificates</div>
                  </li>
                  <li class="col-sm-12 col-md-3  col-lg-2 text-white">
                    <i class="icon-protection"></i>
                    <div class="mergecolor">Protection</div>
                  </li>
                </ul>
              </div>
          ...
          <div class="table-responsive-lg">
            <table class="table sample mt-5">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="title-table" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span class="fas fa-check-circle me-2 f-20"></span> Instant Provisioning</div>
                  </td>
                  <td><span class="fas fa-check-circle me-2 f-20"></span> Intel Xeon</td>
                  <td><span class="fas fa-check-circle me-2 f-20"></span> Free cPanel</td>
                </tr>
                <tr>
                  <td>
                    <div class="title-table" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span class="fas fa-check-circle me-2 f-20"></span> CentOS / Ubuntu</div>
                  </td>
                  <td><span class="fas fa-check-circle me-2 f-20"></span> SuperMicro</td>
                  <td><span class="fas fa-check-circle me-2 f-20"></span> WHMCS</td>
                </tr>
                <tr>
