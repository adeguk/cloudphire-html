...
<html lang="en">
  ...
  <div class="box-container limit-width">
            ...
            <div class="slider-content">
              <div class="container">
                ...
                <div class="col-sm-12 col-md-8 px-0">
                  ...
                  <p data-aos="fade-up" data-aos-duration="1200" class="subheading">Powerful servers with high-end resources that will guarantee resource exclusivity, starting at just 
                    <b class="c-pink">$90.22/mo</b>
                  </p>
                  <a href="vps.php" class="btn btn-default-yellow-fill me-3 mt-3">Get Prices</a>
                  <a href="vps.php" class="btn btn-default-pink-fill mt-3">Learn more</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <!-- ***** CASE STUDY ***** -->
    <section class="casestudy bg-colorstyle">
      <div class="container">
