...
<html lang="en">
  ...
  <div class="box-container limit-width">
        ...
        <div class="carousel header-main-slider">
          ...
          <div class="carousel-cell overlay">
            <div class="slider-content">
              <div class="container">
                <img class="svg custom-element-right" src="assets/patterns/voip.svg" alt="Voip">
                <div class="col-sm-12 col-md-6 px-0">
                  <h1 data-aos="fade-up" data-aos-duration="800">Virtual <br>Numbers</h1>
                  <div data-aos="fade-up" data-aos-duration="1200" class="included">
                    <div class="row">
                      <div class="col-md-12">
                        <ul class="lh-lg">
                  ...
                  <a href="voip.php" class="btn btn-default-yellow-fill me-3 mt-3">Get Prices</a>
                  <a href="voip.php" class="btn btn-default-pink-fill mt-3">Learn more</a>
                </div>
              </div>
            </div>
            <div class="carousel full-slider">
                <img src="assets/img/topbanner11.jpg" alt="VOIP">
            </div>
          </div>
          <!-- 2 Slider -->
          <div class="carousel-cell overlay">
            <div class="slider-content">
              <div class="container">
                <img class="svg custom-element-right" src="assets/patterns/iptvdevices.svg" alt="IPTV">
                <div class="col-sm-12 col-md-6 px-0">
                  <h1 data-aos="fade-up" data-aos-duration="800">IPTV <br>Premium <br>Services</h1>
                  <p data-aos="fade-up" data-aos-duration="1200">Sport, cinema, series, youth, discovery and more. We have gathered all the programs you love. 
                    <b class="c-pink">Subscribe now for only $9.99/yr</b>
                  </p>
                </div>
              </div>
            </div>
            <div class="carousel full-slider">
                <img src="assets/img/topbanner10.jpg" alt="IPTV">
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- ***** PRICING TABLES ***** -->
    <section class="pricing special sec-up-slider bg-colorstyle nopadding specialposition">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="wrapper first text-start noshadow">
              <div class="top-content bg-seccolorstyle topradius">
                ...
                <div class="price mergecolor"><sup>$</sup>8.19 <span class="period">/month</span></div>
    ...
    <!-- ***** LOAD BALANCING ***** -->
    <section class="balancing sec-normal pb-80 bg-white bg-colorstyle">
              ...
              <div class="wrap-service load">
                ...
                <div class="row text-info text-center">
                  <div class="col-md-4 pb-2 pt-5"><b class="c-purple">[1] Users</b> <br>
                    <span class="info seccolor">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</span>
                  </div>
        ...
        <div class="service-wrap">
          <div class="row">
            <div class="col-sm-12 text-center">
              ...
              <p class="section-subheading text-white"><span class="golink">Lorem ipsum dolor</span> sit amet, consectetur adipiscing elit sed, do eiusmod tempor  <span class="c-pink">incididunt lorem ipsum</span> dolor sit amet</p>
            </div>
    ...
    <!-- ***** CONTACT FORM ***** -->
    <section id="ticket" class="bg-colorstyle toppadding bottomhalfpadding">
      <div class="container">
    ...
    <!-- ***** HELP ***** -->
    <section class="services help pt-4 pb-80 notoppadding bg-colorstyle">
      <div class="container">
        <div class="service-wrap">
          <div class="row">
