...
<html lang="en">
  <head>
    ...
    <link href="404.php" disabled="true" rel="stylesheet" class="rtl">
    <!-- CSS styles -->
      ...
      <div class="silder-container">
        <div class="carousel header-main-slider">
          ...
          <div class="carousel-cell top-banner  overlay">
            <div class="slider-content">
              <div class="container ">
                <img class="svg custom-element-right" src="assets/patterns/controlpanel.svg" alt="Shared Hosting">
                <div class="col-sm-12 col-md-7 px-0">
                  <h1 class="heading" data-aos="fade-up" data-aos-duration="800">Shared Hosting</h1>
                  <p class="subheading text-break" data-aos="fade-up" data-aos-duration="1200">Blazing fast & stable hosting infrastructure</p>
                  <div class="included mb-4">
                    <div class="row">
                      <div class="col-sm-12 col-md-6 col-lg-5">
                        <ul><li><i class="fas fa-check-circle"></i> c-Panel or Plesk</li></ul>
                        <ul><li><i class="fas fa-check-circle"></i> Unlimited email</li></ul>
                        <ul><li><i class="fas fa-check-circle"></i> Free SSL certificate</li></ul>
                      </div>
                      <div class="col-sm-12 col-md-6 col-lg-6 secfeat">
                        <ul><li><i class="fas fa-check-circle"></i> Redundant DNS</li></ul>
                        <ul><li><i class="fas fa-check-circle"></i> Powerful SSD</li></ul>
                        <ul><li><i class="fas fa-check-circle"></i> Support 24/7/365</li></ul>
                      </div>
                    </div>
                  </div>
                  <a href="hosting.php" class="btn btn-default-yellow-fill me-2">Get Prices</a>
                </div>
              </div>
            </div>
            <div class="slider-video">
        ...
        <div class="service-wrap">
          <div class="row">
            <div class="col-sm-12 text-center">
              <h2 class="section-heading seccolor">Why Choose Antler?</h2>
        ...
        <div class="service-wrap">
          <div class="row">
            <div class="col-sm-12 text-center">
              ...
              <p class="section-subheading text-muted seccolor"><span class="golink">Lorem ipsum dolor</span> sit amet, consectetur adipiscing elit sed, do eiusmod tempor  <span class="c-pink">incididunt lorem ipsum</span> dolor sit amet</p>
            </div>
