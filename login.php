  ...
  <div class="box-container limit-width">
    ...
    <div class="fullrock config sec-bg3 motpath bg-colorstyle">
      ...
      <section class="fullrock-content">
        <div class="container">
          <a href="index.php"><img class="svg logo-menu d-block" src="assets/img/logo.svg" alt="logo Antler"></a>
          <a href="index.php"><img class="svg logo-menu d-none" src="assets/img/logo-light.svg" alt="logo Antler"></a>
              ...
              <div class="col-sm-12">
                ...
                <div class="table tabs-item">
                  <div class="cd-filter-block mb-0">
                    ...
                    <div class="cd-filter-content">
                      <form action="http://inebur.com/whmcs/register.php/?systpl=antler" method="post" name="orderfrm" class="comments-form">
                        ...
                        <div class="mergecolor"><small>Billing Address</small></div>
                        <div class="row mb-5">
                          <div class="col-md-6 position-relative">
                            <label for="inputCompanyName"><i class="fas fa-building"></i></label>
                            <input type="text" name="companyname" id="inputCompanyName" placeholder="Company Name (Optional)">
                          </div>
                          <div class="col-md-6 position-relative">
                            <label for="inputAddress1"><i class="far fa-building"></i></label>
                            <input type="text" name="address1" id="inputAddress1" placeholder="Street Address" required="">
                          </div>
                          <div class="col-md-6 position-relative">
                            <label for="inputAddress2"><i class="fas fa-map-marker-alt"></i></label>
                            <input type="text" name="address2" id="inputAddress2" placeholder="Street Address 2">
                          </div>
                          <div class="col-md-6 position-relative">
                          ...
                          <div class="row mb-5">
                            ...
                            <div class="col-md-6 position-relative">
                              ...
                              <input type="password" name="password2" id="inputNewPassword2" placeholder="Confirm Password" value="">
                            </div>
                          </div>
                          <div class="mergecolor"><small>Security Answer</small></div>
                          <div class="row mb-5">
                            <div class="col-md-6 position-relative">
                              <div class="cd-select mt-4">
                            ...
                            <div class="col-md-6 position-relative">
                              ...
                              <input type="password" name="securityqans" id="inputSecurityQAns" placeholder="Please enter an answer">
                            </div>
                          </div>
