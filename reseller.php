    ...
    <div class="row justify-content-end scrollme">
      ...
      <div class="col-sm-12 col-md-6 col-lg-4 animateme" data-when="span" data-from="0" data-to="1" data-opacity="1" data-translatey="50">
        <div class="wrapper price-container text-start wow animated fadeInUp fast noshadow">
          ...
          <div class="top-content bg-seccolorstyle topradius">
            <img class="svg mb-3" src="assets/fonts/svg/cloudlinux.svg" height="65" alt="">
    ...
    <div class="sec-main sec-bg1 bg-colorstyle noshadow nopadding">
      <div class="row">
        <div class="col-md-12 col-lg-5 wow animated fadeInUp fast">
          <img class="svg first" src="assets/patterns/api.svg" alt="api automation">
        </div>
      ...
      <div class="row">
        <div class="col-md-12 col-lg-6 wow animated fadeInUp fast ">
          <img class="svg third" src="assets/patterns/install.svg" alt="1-click-installer">
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-4 animateme" data-when="enter" data-from="1" data-to="0" data-opacity="1" data-translatex="-60" data-easeinout="0">
          <div class="service-section bg-seccolorstyle noshadow">
            <img class="svg" src="assets/fonts/svg/hierarchy.svg" alt="">
          ...
          <div class="table-responsive-lg">
            <table class="table sample mt-5">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="title-table" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."> <span class="fas fa-check-circle me-2"></span> Latest cPanel</div>
                  </td>
                  <td><span class="fas fa-check-circle me-2"></span> MySQL 5.6</td>
                  <td><span class="fas fa-check-circle me-2"></span> WordPress</td>
                </tr>
                <tr>
                  <td>
                    <div class="title-table" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span class="fas fa-check-circle me-2"></span> CloudLinux 6.9</div>
                  </td>
                  <td><span class="fas fa-check-circle me-2"></span> phpMyAdmin 4.6.6</td>
                  <td><span class="fas fa-check-circle me-2"></span> Joomla, Prestashop</td>
                </tr>
                <tr>
                  <td class="title-table"><span class="fas fa-check-circle me-2"></span> PHP 5.5/5.6/7.0</td>
                  <td><span class="fas fa-check-circle me-2"></span> FTPES Supported</td>
                  <td><span class="fas fa-check-circle me-2"></span> Zend Engine</td>
                </tr>
                <tr>
                  <td class="title-table"><span class="fas fa-check-circle me-3"></span>Python 2.6.6</td>
                  <td><span class="fas fa-check-circle me-2"></span> MSSQL Stored Procedures</td>
                  <td><span class="fas fa-check-circle me-2"></span> ionCube Loader </td>
                </tr>
                <tr>
