...
?>
        ...
        <div class="carousel header-main-slider">
          ...
          <div class="carousel-cell sec-bg6 bg-colorstyle">
            <div class="slider-content">
              <div class="container ">
                <img class="svg custom-element-right" src="assets/patterns/ddoslayers.svg" alt="DDos Monitoring">
                <div class="col-sm-12 col-md-6 px-0">
                  <h1 class="mergecolor">DDoS <br><span id="typed2"></span> <br>Websites</h1>
                  <p class="mergecolor">Automatic Mitigation for Sophisticated DDoS that quickly defeats attacks without impacting site performance. Starting for only <b class="c-pink">$19.99/year</b></p>
                  <a href="ddos.php" class="btn btn-default-yellow-fill me-2 mb-2">Get Prices</a>
                  <a href="ddos.php" class="btn btn-default-pink-fill mb-2">Learn more</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-cell sec-bg6 bg-colorstyle">
            <div class="slider-content">
              <div class="container">
                ...
                <div class="col-sm-12 col-md-6 px-0">
                  <h1 class="mergecolor">Dedicated <br>Server with <br> <span id="typed1"></span></h1>
                  <p class="mergecolor">Powerful servers with high-end resources that will guarantee resource exclusivity, starting at just <b class="c-pink">$90.22/mo</b>
                  </p>
                  <a href="dedicated.php" class="btn btn-default-yellow-fill me-2 mb-2">Get Prices</a>
                  <a href="dedicated.php" class="btn btn-default-pink-fill mb-2">Learn more</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <!-- ***** PRICING TABLES ***** -->
    <section class="slick sec-normal pt-4 bg-seccolorstyle toppadding bottompadding">
      <div id="slider">
        <div class="plan-container">
          <div class="wrapper noshadow">
            <div class="top-content bg-colorstyle">
        ...
        <div class="plan-container">
          <div class="wrapper noshadow">
            <div class="top-content bg-colorstyle">
              <img class="svg mb-3" src="assets/fonts/svg/reseller.svg" alt="">
    ...
    <!-- ***** CASE STUDY ***** -->
    <section class="casestudy sec-normal sec-bg2 exapath scrollme bg-seccolorstyle">
      <div class="container">
        <div class="sec-main bg-purple mb-0 animateme" data-when="span" data-from="1" data-to="0" data-opacity="1" data-translatey="80">
