...
<html lang="en">
  ...
  <div class="box-container limit-width">
    ...
    <!-- ***** SLIDER ***** -->
    <div class="top-header item11 overlay">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12">
            <div class="wrapper">
              <h1 class="heading">VOIP for Global <br>Entrepreneurs</h1>
              <div class="included">
                <h4 class="mb-3">Buy a toll free number<br> and forward calls anywhere.</h4>
                <ul>
                  <li><i class="fas fa-check-circle"></i> Buy Toll Free Numbers Fast</li>
                </ul>
                <ul>
                  <li><i class="fas fa-check-circle"></i> 20+ VoIP Number Features Included </li>
                </ul>
                <ul>
                  <li><i class="fas fa-check-circle"></i> Toll Free Phone Forwarding to Any Location </li>
                </ul>
                <ul>
                  <li><i class="fas fa-check-circle"></i> Activate International 800 Numbers Instantly</li>
                </ul>
                <ul>
                  <li><i class="fas fa-check-circle"></i> No Setup Fees or Minimum Contracts</li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <!-- ***** PRICING TABLES ***** -->
    <section class="pricing special sec-uping pb-5 scrollme">
      <div class="container">
        <div class="row justify-content-end">
          <div class="col-sm-12 col-md-12 col-lg-7">
            <div class="wrapper price-container text-start animateme bg-colorstyle" data-when="span" data-from="0" data-to="0.75" data-opacity="1" data-translatey="-50">
              <div class="plans badge feat bg-grey">phone numbers</div>
              <div class="top-content cd-filter-block pb-5">
                <div class="row">
                  <div class="col-md-12 mergecolor">Where would you like to have a phone number?</div>
                  <div class="col-md-6">
                    ...
                    <div class="cd-select mt-4">
                      ...
                      <select name="state" class="select-filter"><option>State Number Type</option><option>Alabama</option><option>Alaska</option><option>Arizona</option><option>Arkansas</option><option>California</option><option>Colorado</option><option>Connecticut</option><option>Delaware</option><option>District of Columbia</option><option>Florida</option><option>Georgia</option><option>Hawaii</option><option>Idaho</option><option>Illinois</option><option>Indiana</option><option>Iowa</option><option>Kansas</option><option>Kentucky</option><option>Louisiana</option><option>Maine</option><option>Maryland</option><option>Massachusetts</option><option>Michigan</option><option>Minnesota</option><option>Mississippi</option><option>Missouri</option><option>Montana</option><option>Nebraska</option><option>Nevada</option><option>New Hampshire</option><option>New Jersey</option><option>New Mexico</option><option>New York</option><option>North Carolina</option><option>North Dakota</option><option>Ohio</option><option>Oklahoma</option><option>Oregon</option><option>Pennsylvania</option><option>Rhode Island</option><option>South Carolina</option><option>South Dakota</option><option>Tennessee</option><option>Texas</option><option>Utah</option><option>Vermont</option><option>Virginia</option><option>Washington</option><option>West Virginia</option><option>Wisconsin</option><option>Wyoming</option></select>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="cd-select mt-4">
                      <label class="db"></label>
                      <select name="state" class="select-filter"><option>Select Your Number</option><option>800 150 223</option><option>800 150 123</option><option>800 150 233</option><option>800 150 001</option> <option>800 150 023</option><option>800 150 102</option><option>800 150 355</option><option>800 150 233</option><option>800 150 120</option><option>800 150 220</option><option>800 150 222</option><option>800 150 113</option><option>800 150 000</option><option>800 150 111</option><option>800 150 214</option><option>800 150 212</option><option>800 150 223</option><option>800 150 200</option><option>800 150 003</option><option>800 150 113</option></select>
                    </div>
                    <a href="" class="btn btn-block btn-default-yellow-fill">Sign Up & Try For Free</a>
                  </div>
                  <div class="col-md-12 c-grey fromer mt-4 seccolor">Bring your old number to Antler <span class="golink text-start">Need help?</span></div>
                </div>
              </div>
            </div>
          </div>
    ...
    <!-- ***** PRICING TABLES ***** -->
    <section class="pricing special sec-normal pt-4 exapath bottompadding tophalfpadding bg-colorstyle">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="wrapper first text-start wow animated fadeInUp fast noshadow">
              <div class="top-content bg-seccolorstyle topradius">
                <img class="svg mb-3" src="assets/fonts/svg/mobile.svg" alt="">
                <div class="title">VOIP Basic</div>
                <div class="fromer seccolor">$0.061 /additional minute</div>
                <div class="price mergecolor"><sup>$</sup>6.99 <span class="period">/mo</span></div>
                <a href="" class="btn btn-default-yellow-fill">Buy now</a>
              </div>
              <ul class="list-info">
                <li><i class="icon-clock"></i> <span class="c-purple">MINUTES</span><br> <span>297</span></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="wrapper text-start wow animated fadeInUp noshadow">
              <div class="plans badge feat bg-pink">most popular</div>
              <div class="top-content bg-seccolorstyle topradius">
                <img class="svg mb-3" src="assets/fonts/svg/mobile.svg" alt="">
                <div class="title">VOIP Advance</div>
                <div class="fromer seccolor">$0.043 /additional minute</div>
                <div class="price mergecolor"><sup>$</sup>24.99 <span class="period">/mo</span></div>
                <a href="" class="btn btn-default-yellow-fill">Buy now</a>
              </div>
              <ul class="list-info bg-purple">
                <li><i class="icon-clock"></i> <span class="c-pink">MINUTES</span><br> <span>1150</span></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="wrapper third text-start wow animated fadeInUp fast noshadow">
              <div class="top-content bg-seccolorstyle topradius">
                <img class="svg mb-3" src="assets/fonts/svg/mobile.svg" alt="">
                <div class="title">VOIP Premium</div>
                <div class="fromer seccolor">$0.025 /additional minute</div>
                <div class="price mergecolor"><sup>$</sup>69.00 <span class="period">/mo</span></div>
                <a href="" class="btn btn-default-yellow-fill">Buy now</a>
              </div>
              <ul class="list-info">
                <li><i class="icon-clock"></i> <span class="c-purple">MINUTES</span><br> <span>3900</span></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <!-- ***** FEATURES ***** -->
    <section class="sec-normal history-section sec-bg2 bg-colorstyle">
      <div class="container">
        <div class="sec-main sec-bg1 bg-colorstyle noshadow nopadding">
          <div class="row">
            <div class="col-md-10 offset-md-1">
              <div class="info-content">
                <h2 class="mb-4 mergecolor"><b>Buy a free number and calls anywhere</b></h2>
                <p class="seccolor">But I must explain to you how all this mistaken idea of <a href="#" class="golink">denouncing pleasure</a> and praising pain was born and I will. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
            ...
            <div class="col-md-10 offset-md-1 pt-5 wow animated fadeInUp fast">
              <img class="svg" src="assets/patterns/voice.svg" alt="security">
            </div>
          </div>
          <div class="row">
            <div class="col-md-10 offset-md-1">
              <div class="info-content">
                <h2 class="mb-4 mergecolor"><b>Have your own local phone number anywhere</b></h2>
                <p class="seccolor">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will. Lorem ipsum dolor sit amet, <a href="#" class="golink">consectetur adipiscing elit,</a> sed do eiusmod tempor incididunt.</p>
                <p class="seccolor">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
              </div>
            </div>
            <div class="col-md-10 offset-md-1 pt-5 wow animated fadeInUp fast">
              <img class="svg" src="assets/patterns/virtualnumbers.svg" alt="quarantine">
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- ***** WHY CHOOSE ANTLER ***** -->
    <section class="services sec-normal sec-bg4 exapath scrollme">
      <div class="container">
        <div class="service-wrap">
          <div class="row">
            <div class="col-sm-12 text-center">
              <h2 class="section-heading">Why International Companies Choose Antler?</h2>
            ...
            <div class="col-sm-12 col-md-4 animateme" data-when="enter" data-from="1" data-to="0" data-opacity="1" data-translatey="-100" data-easeinout="0">
              <div class="service-section bg-colorstyle">
                <img class="svg" src="assets/fonts/svg/freenetwork.svg" alt="">
                <div class="title mergecolor">Worldwide Reliability</div>
            ...
            <div class="col-sm-12 col-md-4 animateme" data-when="enter" data-from="1" data-to="0" data-opacity="1" data-translatey="100" data-easeinout="0">
              <div class="service-section bg-colorstyle">">
                <img class="svg" src="assets/fonts/svg/diamond.svg" alt="">
                <div class="title mergecolor">Superior Call Quality</div>
                <p class="subtitle seccolor">
            ...
            <div class="col-sm-12 col-md-4 animateme" data-when="enter" data-from="1" data-to="0" data-opacity="1" data-translatey="-100" data-easeinout="0">
              <div class="service-section bg-colorstyle">">
                <div class="plans badge feat bg-pink">grow</div>
                <img class="svg" src="assets/fonts/svg/progress.svg" alt="">
                <div class="title mergecolor">Simplified Scalability</div>
                <p class="subtitle seccolor">
                  Excepteur sint occaecat cupidatat non proident voluptate. Lorem ipsum dolor sit amet, consectetur.
                </p>
              </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
              <h2 class="section-heading mergecolor">Frequently Asked Questions VOIP</h2>
              ...
              <div class="accordion faq pt-5">
                <div class="panel-wrap">
                  <div class="panel-title mergecolor active">
                    <span>How long will take to set up my toll free number service?</span>
                    <div class="float-end">
                ...
                <div class="panel-wrap">
                  <div class="panel-title mergecolor">
                    <span>Can I get an international toll free number that works for multiple countries?</span>
                    <div class="float-end">
                      <i class="fa fa-plus"></i>
                      <i class="fa fa-minus c-pink"></i>
                    </div>
                ...
                <div class="panel-wrap">
                  <div class="panel-title mergecolor">
                    <span>Can I forward calls from my international 800 numbers to my mobile phone?</span>
                    <div class="float-end">
                      <i class="fa fa-plus"></i>
                      <i class="fa fa-minus c-pink"></i>
                    </div>
                ...
                <div class="panel-wrap">
                  <div class="panel-title mergecolor">
                    <span>What other services can Antler offer to help my business?</span>
                    <div class="float-end">
                      <i class="fa fa-plus"></i>
                      <i class="fa fa-minus c-pink"></i>
                    </div>
