          ...
          <div class="table-responsive-lg">
            <table class="table sample mt-5">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="title-table" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span class="fas fa-check-circle me-2"></span>
                      CentOS 6/7, Ubuntu 16v</div>
                  </td>
                ...
                <tr>
                  <td>
                    <div class="title-table" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span class="fas fa-check-circle me-2"></span> Fedora 23, Debian 8</div>
                  </td>
                ...
                <tr>
                  <td class="title-table"><span class="fas fa-check-circle me-2"></span> Private Network</td>
                  <td><span class="fas fa-check-circle me-2"></span> Juniper Networks</td>
                  <td><span class="fas fa-check-circle me-2"></span> WHMCS</td>
                </tr>
                <tr>
                  <td class="title-table"><span class="fas fa-check-circle me-3"></span> Quick VNC access</td>
          ...
          <div class="h-plans-info">
            <div class="content-price price-container bg-seccolorstyle noshadow">
              ...
              <div class="price-content">
                ...
                <div class="infos seccolor">
                  <div class="badge feat bg-grey">Info</div> If you subscribe for an extended period, you will get a discount
                </div>
