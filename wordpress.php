...
<html lang="en">
  ...
  <div class="box-container limit-width">
          ...
          <div class="col-sm-12 col-md-12">
            <div class="wrapper">
              ...
              <div class="included">
                ...
                <ul><li><i class="fas fa-check-circle"></i> Control Panel</li></ul>
                <ul><li><i class="fas fa-check-circle"></i> Server Caching Tools</li></ul>
                <ul><li><i class="fas fa-check-circle"></i> SSL & Privacy Included</li></ul>
                <ul><li><i class="fas fa-check-circle"></i> Daily Backups</li></ul>
                <ul><li><i class="fas fa-check-circle"></i> Powerful SSD Storage</li></ul>
    ...
    <!-- ***** FEATURES ***** -->
    <section id="scroll" class="history-section feat01 sec-normal sec-bg2 motpath bg-colorstyle">
      <div class="container">
        <div class="sec-main sec-bg1 bg-colorstyle noshadow nopadding">
          ...
          <div class="row">
            <div class="col-md-12 col-lg-5 wow animated fadeInUp fast first">
              <img class="svg" src="assets/patterns/dns.svg" alt="dns redundant">
            </div>
    ...
    <!-- ***** HELP ***** -->
    <section class="help sec-normal pt-4 bg-colorstyle">
      <div class="container">
